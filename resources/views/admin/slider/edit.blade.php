...
@section('content')
    <form action="" method="POST">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="thumb" value="{{ $slider->thumb }}" name="thumbDefault" id="thumbDefault">
            </div>
    ...
    <script>
        ...
        document.getElementById('thumb').addEventListener('change', (e) => {
            ...
            if (file) {
                image_show.querySelector('a').href = URL.createObjectURL(file)
                image_show.querySelector('img').src = URL.createObjectURL(file)
            }
